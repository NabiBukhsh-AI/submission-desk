...
def sample_hashes() -> frozenset[str]:
    """The content hashes of every file that ships as a sample.

    Read once per process. A run whose documents are all in here is one of
    the demo candidates, which the delete use case refuses to remove.
    """
